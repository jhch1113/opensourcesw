...
*__Note:__* This document is written merely as an illustrative example, and does not provide  
...
In order to build it, I will use [opencv](https://opencv.org/), deep learning libraries, such as [TensorFlow](https://www.tensorflow.org/)  
